...
//             throw std::runtime_error("Max. number of boundary nodes
//             exceeded.");
//           }
...
//   if (ie != phyEdges) {
//     throw std::runtime_error("did not get correct number of interior
//     edges.");
//   }

//   if (ie != phyEdges) {
//     throw std::runtime_error("did not get the coorect number of dummy
//     edges.");
//   }
// }
...
//   // It's more robust to blank lines and the specific ordering of the SU2
//   file.
...
//       vprod =
//           sx * (coords[j].x - coords[i].x) + sy * (coords[j].y -
//           coords[i].y);
